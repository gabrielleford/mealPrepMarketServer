...
app.use(cors({credentials: true, origin: 'http://localhost:3000'}, method,['GET','PUT','POST','DELETE'], exposedHeaders,'Content-Range', allowedHeaders,['Origin', 'X-Requested-With', 'Content-Type', 'Accept', 'Authorization']));
